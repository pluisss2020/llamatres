...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-09-2021 a las 21:01:46
...
--
-- Estructura de tabla para la tabla `material_impreso`
--
...
--
-- Indices de la tabla `material_impreso`
--
ALTER TABLE `material_impreso`
...
--
-- AUTO_INCREMENT de la tabla `material_impreso`
--
ALTER TABLE `material_impreso`
